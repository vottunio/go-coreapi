...
const (
	...
	CustodiedWalletCoreMutableUrl                 string = "evm/wallet/custodied/transact/mutable?stragegy=%d"
	CoreMutableUrl                                string = "evm/transact/mutable"
	TransferNativeNetworkCryptoUrl                string = "evm/chain/transfer"
	CustodiedWalletTransferNativeNetworkCryptoUrl string = "evm/wallet/custodied/transfer?stragegy=%d"
